...
cd "$PROJECT_DIR"
sudo docker exec stock-server python /app/stock_ai_v21/historical_backtest_system/build_historical_backtest.py \
...
sudo chown -R "$(id -un):$(id -gn)" \
  ...
  "$PROJECT_DIR/reports"/historical_backtest_*.md 2>/dev/null || true
