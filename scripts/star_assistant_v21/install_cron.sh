...
25 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_valuation_layer.sh >> $LOG_DIR/valuation_layer_cron.log 2>&1
35 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_final_layers.sh >> $LOG_DIR/final_layers_cron.log 2>&1
38 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_data_quality.sh >> $LOG_DIR/data_quality_cron.log 2>&1
40 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_fundamental_first.sh >> $LOG_DIR/fundamental_first_cron.log 2>&1
45 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/run_paper_portfolio.sh >> $LOG_DIR/paper_portfolio_cron.log 2>&1
50 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_holding_review.sh >> $LOG_DIR/holding_review_cron.log 2>&1
55 22 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_strategy_validation.sh >> $LOG_DIR/strategy_validation_cron.log 2>&1
0 23 * * 1-5 PROJECT_DIR=$PROJECT_DIR $PROJECT_DIR/scripts/star_assistant_v21/build_forward_validation.sh >> $LOG_DIR/forward_validation_cron.log 2>&1
